package demo.wj.customlayoutsample.common;
...
import demo.wj.customlayoutsample.R;
import demo.wj.customlayoutsample.ScreenUtilsKt;
...
public class Common01AdjustablePanel extends RelativeLayout {
    ...
    float bottomMargin = ScreenUtilsKt.dip2Px(this,48);
    float minWidth = ScreenUtilsKt.dip2Px(this,80);
    float minHeight = ScreenUtilsKt.dip2Px(this,100);
